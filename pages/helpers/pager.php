...
<div class='pager rounded-bottom'>&nbsp;
    <div class="float-right mr-1 ml-0 small pointer pagerbutton" id="<?php echo $pagername ?>last" title='last page' value=''><img src='images/end.svg' /></div>
    <div class="float-right mr-0 ml-0 small pointer pagerbutton" id="<?php echo $pagername ?>end" title='next page' value='9'><img src='images/chevron-right.svg' /></div>
    <div class="float-right m-0 p-0 small pagerposition" id="<?php echo $pagername ?>position"></div>
